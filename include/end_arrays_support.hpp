    ...
    void build()
    {
        ...
        for (pfpds::long_type i = 0; i < l2_p.saP.size(); i++)
        {
            ...
            else
            {
                ...
                //sa-1 bc extra value in SA from gasak algo. Then -1 from parse value bc first phrase is value 1.
                // Stores the ending positions of every occurrence of every phrase in the parse in SA order per phrase id.
            }
        }
